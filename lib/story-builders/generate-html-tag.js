...
exports.generateHtmlTag = (config) => {
    ...
    const children = config.children ? config.children.map(child => exports.generateHtmlTag(child)).join('') : (config.innerHTMLasKnob ? get_knob_renderer_1.getKnobRenderer("text") : config.innerHTML);
